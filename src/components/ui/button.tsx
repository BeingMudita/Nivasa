  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        warm: "bg-gradient-warm text-foreground border border-border hover:shadow-soft",
        gradient: "bg-gradient-primary text-primary-foreground hover:shadow-floating",
        floating: "bg-card text-card-foreground shadow-floating hover:shadow-card border border-border/50 hover:scale-105 transition-spring",
        conversation: "bg-chat-bubble text-foreground border border-border hover:bg-accent/50 rounded-2xl",
      },
      size: {
